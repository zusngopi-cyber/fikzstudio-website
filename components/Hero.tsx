    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-32 text-center z-10">
        <div className="animate-fade-in">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-white text-sm font-semibold mb-8">
          ...
          <p className="text-xl md:text-2xl text-gray-200 mb-12 max-w-3xl mx-auto leading-relaxed">
            We create stunning websites, boost SEO rankings, and deliver digital solutions that drive real business growth
          </p>
          ...
          <div className="flex gap-4 justify-center flex-wrap mb-16">
            <a
              ...
              className="group bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white px-8 py-4 rounded-xl font-semibold transition-all hover:scale-105 hover:shadow-2xl flex items-center gap-2"
            >
          ...
          <div className="flex items-center justify-center gap-12 text-white/80 flex-wrap">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <div className="text-sm">Lightning Speed</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center">
